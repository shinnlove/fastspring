 ...
 */
package com.shinnlove.fastspring.web.controller.team;
...
import com.shinnlove.fastspring.common.dal.RandomTeamDao;
import com.shinnlove.fastspring.common.dal.model.RandomTeam;
import com.shinnlove.fastspring.common.util.log.ExceptionUtil;
import com.shinnlove.fastspring.common.util.log.LoggerUtil;
import com.shinnlove.fastspring.common.util.system.exception.SystemException;
                ...
                try {
                    ...
                    if (exist <= 0) {
                        ...
                        for (int j = 0; j < size; j++) {
                            ...
                            if (j == 0)
                                copyWeight(ids, 0, id, 100); // w100
                            if (j == 1)
                                copyWeight(ids, 100, id, 80); // w80
                            if (j == 2)
                                copyWeight(ids, 180, id, 30); // w30
                            if (j == 3)
                                copyWeight(ids, 210, id, 10); // w10
                        }
