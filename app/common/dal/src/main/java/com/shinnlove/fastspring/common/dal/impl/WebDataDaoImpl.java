 ...
 */
package com.shinnlove.fastspring.common.dal.impl;
...
import com.shinnlove.fastspring.common.dal.WebDataDao;
...
public class WebDataDaoImpl implements WebDataDao {
    ...
    /**
     * @see com.shinnlove.fastspring.common.dal.WebDataDao#saveWebData(WebData) 
     */
    @Override
    ...
    /**
     * @see com.shinnlove.fastspring.common.dal.WebDataDao#getWebDataById(int)
     */
    @Override
    ...
    /**
     * @see com.shinnlove.fastspring.common.dal.WebDataDao#queryWebDataByPage(WebDataRequest, int, int)
     */
    @Override
    ...
    /**
     * @see com.shinnlove.fastspring.common.dal.WebDataDao#queryAllWebDataByPage(WebDataRequest)
     */
    @Override
    public List<WebData> queryAllWebDataByPage(WebDataRequest request) {
        ...
        try {
            ...
            webDataList = criteria
                ...
                .add(Restrictions.like("cContent", "%" + content + "%")).add(creterion)
                .addOrder(Order.desc("pubtime")).list();
